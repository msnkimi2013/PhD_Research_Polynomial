...
while True:
    ...
    if len(cnt_center_pos) == 8 :
        ...
        upper_4pos = [first_frame_pos_sorted[0], second_frame_pos_sorted[0], third_frame_pos_sorted[0], fourth_frame_pos_sorted[0]]
        lower_4pos = [first_frame_pos_sorted[1], second_frame_pos_sorted[1], third_frame_pos_sorted[1], fourth_frame_pos_sorted[1]]


        upper_x = [upper_4pos[0][0], upper_4pos[1][0], upper_4pos[2][0], upper_4pos[3][0]]
        upper_y = [upper_4pos[0][1], upper_4pos[1][1], upper_4pos[2][1], upper_4pos[3][1]]

        lower_x = [lower_4pos[0][0], lower_4pos[1][0], lower_4pos[2][0], lower_4pos[3][0]]
        lower_y = [lower_4pos[0][1], lower_4pos[1][1], lower_4pos[2][1], lower_4pos[3][1]]
