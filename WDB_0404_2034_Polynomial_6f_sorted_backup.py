...
while True:
    ...
    if len(cnt_center_pos) == 12 :
        ...
        upper_6pos = [first_frame_pos_sorted[0], second_frame_pos_sorted[0], third_frame_pos_sorted[0], fourth_frame_pos_sorted[0], fifth_frame_pos_sorted[0], sixth_frame_pos_sorted[0]]
        lower_6pos = [first_frame_pos_sorted[1], second_frame_pos_sorted[1], third_frame_pos_sorted[1], fourth_frame_pos_sorted[1], fifth_frame_pos_sorted[1], sixth_frame_pos_sorted[1]]
