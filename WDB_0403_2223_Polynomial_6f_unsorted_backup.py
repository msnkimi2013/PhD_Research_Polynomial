...
while True:
    ...
    if len(cnt_center_pos) == 12 :
        ...
        sixth_frame_pos = [cnt_center_pos[10], cnt_center_pos[11]]
        ...
        # sixth_frame_pos_sorted = sorted(sixth_frame_pos, key=take_second, reverse=True)

        #print(first_frame_pos_sorted)


        upper_6pos = [first_frame_pos[0], second_frame_pos[0], third_frame_pos[0], fourth_frame_pos[0], fifth_frame_pos[0], sixth_frame_pos[0]]
        lower_6pos = [first_frame_pos[1], second_frame_pos[1], third_frame_pos[1], fourth_frame_pos[1], fifth_frame_pos[1], sixth_frame_pos[1]]


        upper_x = [upper_6pos[0][0], upper_6pos[1][0], upper_6pos[2][0], upper_6pos[3][0], upper_6pos[4][0], upper_6pos[5][0]]
        upper_y = [upper_6pos[0][1], upper_6pos[1][1], upper_6pos[2][1], upper_6pos[3][1], upper_6pos[4][1], upper_6pos[5][1]]

        lower_x = [lower_6pos[0][0], lower_6pos[1][0], lower_6pos[2][0], lower_6pos[3][0], lower_6pos[4][0], lower_6pos[5][0]]
        lower_y = [lower_6pos[0][1], lower_6pos[1][1], lower_6pos[2][1], lower_6pos[3][1], lower_6pos[4][1], lower_6pos[5][1]]
    ...
    #     cv2.circle(img, (x, y1), 2, (255, 0, 255), cv2.FILLED)
    #     cv2.circle(img, (x, y2), 2, (255, 0, 255), cv2.FILLED)
    #
    #
    # #
